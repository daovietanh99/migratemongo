...
class RichText {
    constructor() {
        this.$createHeadingNode = $createHeadingNode;
        this.$createQuoteNode = $createQuoteNode;
        this.$isHeadingNode = $isHeadingNode;
        this.$isQuoteNode = $isQuoteNode;
        this.DRAG_DROP_PASTE = DRAG_DROP_PASTE;
        this.HeadingNode = HeadingNode;
        this.QuoteNode = QuoteNode;
        this.eventFiles = eventFiles;
        this.registerRichText = registerRichText;
    }
}
