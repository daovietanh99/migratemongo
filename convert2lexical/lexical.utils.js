...
class Utils {
    constructor() {
    this.$splitNode = lexical.$splitNode;
    this.isBlockDomNode = lexical.isBlockDomNode;
    this.isHTMLAnchorElement = lexical.isHTMLAnchorElement;
    this.isHTMLElement = lexical.isHTMLElement;
    this.isInlineDomNode = lexical.isInlineDomNode;
    this.$dfs = $dfs;
    this.$filter = $filter;
    this.$findMatchingParent = $findMatchingParent;
    this.$getNearestBlockElementAncestorOrThrow = $getNearestBlockElementAncestorOrThrow;
    this.$getNearestNodeOfType = $getNearestNodeOfType;
    this.$getNextRightPreorderNode = $getNextRightPreorderNode;
    this.$insertFirst = $insertFirst;
    this.$insertNodeToNearestRoot = $insertNodeToNearestRoot;
    this.$isEditorIsNestedEditor = $isEditorIsNestedEditor;
    this.$restoreEditorState = $restoreEditorState;
    this.$wrapNodeInElement = $wrapNodeInElement;
    this.CAN_USE_BEFORE_INPUT = CAN_USE_BEFORE_INPUT;
    this.CAN_USE_DOM = CAN_USE_DOM;
    this.IS_ANDROID = IS_ANDROID;
    this.IS_ANDROID_CHROME = IS_ANDROID_CHROME;
    this.IS_APPLE = IS_APPLE;
    this.IS_APPLE_WEBKIT = IS_APPLE_WEBKIT;
    this.IS_CHROME = IS_CHROME;
    this.IS_FIREFOX = IS_FIREFOX;
    this.IS_IOS = IS_IOS;
    this.IS_SAFARI = IS_SAFARI;
    this.addClassNamesToElement = addClassNamesToElement;
    this.calculateZoomLevel = calculateZoomLevel;
    this.isMimeType = isMimeType;
    this.markSelection = markSelection;
    this.mediaFileReader = mediaFileReader;
    this.mergeRegister = mergeRegister;
    this.objectKlassEquals = objectKlassEquals;
    this.positionNodeOnRange = positionNodeOnRange;
    this.registerNestedElementResolver = registerNestedElementResolver;
    this.removeClassNamesFromElement = removeClassNamesFromElement;
    }
}
