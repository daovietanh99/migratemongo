...
class ClipBoard{
    constructor() {
        this.$generateJSONFromSelectedNodes = $generateJSONFromSelectedNodes;
        this.$generateNodesFromSerializedNodes = $generateNodesFromSerializedNodes;
        this.$getHtmlContent = $getHtmlContent;
        this.$getLexicalContent = $getLexicalContent;
        this.$insertDataTransferForPlainText = $insertDataTransferForPlainText;
        this.$insertDataTransferForRichText = $insertDataTransferForRichText;
        this.$insertGeneratedNodes = $insertGeneratedNodes;
