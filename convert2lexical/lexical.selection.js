...
class Selections_ {
    constructor() {
        this.$cloneWithProperties = lexical.$cloneWithProperties;
        this.$addNodeStyle = $addNodeStyle;
        this.$getSelectionStyleValueForProperty = $getSelectionStyleValueForProperty;
        this.$isAtNodeEnd = $isAtNodeEnd;
        this.$isParentElementRTL = $isParentElementRTL;
        this.$moveCaretSelection = $moveCaretSelection;
        this.$moveCharacter = $moveCharacter;
        this.$patchStyleText = $patchStyleText;
        this.$selectAll = $selectAll;
        this.$setBlocksType = $setBlocksType;
        this.$shouldOverrideDefaultCharacterSelection = $shouldOverrideDefaultCharacterSelection;
        this.$sliceSelectedTextNodeContent = $sliceSelectedTextNodeContent;
        this.$trimTextContentFromAnchor = $trimTextContentFromAnchor;
        this.$wrapNodes = $wrapNodes;
        this.createDOMRange = createDOMRange;
        this.createRectsFromDOMRange = createRectsFromDOMRange;
        this.getStyleObjectFromCSS = getStyleObjectFromCSS;
        this.trimTextContentFromAnchor = $trimTextContentFromAnchor;
    }
}

var selection = new Selections_()